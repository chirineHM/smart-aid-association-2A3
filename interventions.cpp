...
bool interventions::add()
{
    ...
    QSqlQuery query;
          query.prepare("INSERT INTO INTERVENTION (ID_INTERVENTION, ID_animal, id_employe,etat,rapport_sante, DATE_INTERVENTION) "
                        "VALUES (:id_i, :id_a, :id_e, :etat, :rapport, :date)");
          query.bindValue(0, id_intervention);
          query.bindValue(1, id_animal);
           query.bindValue(2, id_employe);
          query.bindValue(3, etat);
          query.bindValue(4, rapport_sante);
          query.bindValue(5, date_intervention);
