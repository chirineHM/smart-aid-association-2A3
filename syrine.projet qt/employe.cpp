...
bool Employe::modifier()
    {
        ...
        QSqlQuery query;
            query.prepare("UPDATE Employe SET id_emp=:id_emp, nom_emp=:nom_emp, prenom_emp:=prenom_emp, sexe_emp:=sexe_emp, adresse_emp:=adresse_emp, tel_emp:=tel_emp, date_naiss_emp:=date_naiss_emp, email:=email WHERE id_emp=:id_emp ");
